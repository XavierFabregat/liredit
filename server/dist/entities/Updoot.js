...
const _1 = require(".");
let Updoot = exports.Updoot = class Updoot extends typeorm_1.BaseEntity {
};
__decorate([
...
__decorate([
    ...
    (0, typeorm_1.ManyToOne)(() => _1.User, (user) => user.updoots),
...
__decorate([
    ...
    (0, typeorm_1.ManyToOne)(() => _1.Post, (post) => post.updoots),
